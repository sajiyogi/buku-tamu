...
//apabila user yang mengakses sah
	...
	<body>
	<table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor=" 	 	 	 	#ee9145">
		<tr>
	...
	<tr>
		<td width="200" valign="top" bgcolor="#f0c02b" id="menu">
		<?php include "menu.php"; ?>
		</td>
   		<td align="left" valign="top" bgcolor="#f2ea3c" class="text" id="content"><?php include "konten.php"; ?></td>
    </tr>
    <tr>
		<td height="40" colspan="2" align="center" valign="middle"background="../images/background_1.jpg"><span class="kecil">Copyright <b>Polindra</b> &copy; 2018. All Right Reserved<br><span class="style_text">Design By <a href="http://www.polindra.ac.id" target="_blank">Training
